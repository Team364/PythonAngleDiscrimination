...
def threshold_video(frame):
    ...
    lower_color = np.array([60,220, 30])
    upper_color = np.array([90, 255, 225])
    # lower_color = np.array([60,220,25])
    # upper_color = np.array([90, 255, 255])
    # Default
    # lower_color = np.array([0,220,25])
    # upper_color = np.array([101, 255, 255])
    # Our vision Pipeline
    # lower_color = np.array([71.22302158273381, 22.93165467625899, 240.78237410071944])
    # upper_color = np.array([100.13651877133105, 107.04778156996588, 255.0])
